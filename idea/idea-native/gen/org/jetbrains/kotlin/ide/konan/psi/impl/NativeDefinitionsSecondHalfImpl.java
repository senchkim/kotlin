...
public class NativeDefinitionsSecondHalfImpl extends ASTWrapperPsiElement implements NativeDefinitionsSecondHalf {

  public NativeDefinitionsSecondHalfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NativeDefinitionsVisitor visitor) {
    visitor.visitSecondHalf(this);
  }
